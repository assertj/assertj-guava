...
public class RangeSets {
   ...
   */
  public void assertContains(AssertionInfo info, RangeSet actual, Comparable[] values) {
    assertNotNull(info, actual);
    failIfNull(values);
   ...
   * @throws IllegalArgumentException if elements are null or elements are empty while actual is not empty.
   */
  public void assertContainsAll(AssertionInfo info, RangeSet actual, Iterable<? extends Comparable> values) {
    assertNotNull(info, actual);
    failIfNull(values);
    // Should pass if both actual and expected are empty
   ...
   * @throws IllegalArgumentException if elements are null or elements are empty while actual is not empty.
   */
  public void assertContainsAnyOf(AssertionInfo info, RangeSet actual, Comparable[] values) {
    assertNotNull(info, actual);
    failIfNull(values);
    // Should pass if both actual and expected are empty
    if (actual.isEmpty() && values.length == 0) return;
   ...
   */
  public void assertIntersects(AssertionInfo info, RangeSet actual, Range[] ranges) {
    assertNotNull(info, actual);
    failIfNull(ranges);
    // Should pass if both actual and expected are empty
   ...
   */
  public void assertIntersectsAll(AssertionInfo info, RangeSet actual, Iterable<? extends Range> range) {
    assertNotNull(info, actual);
    failIfNull(range);
    // Should pass if both actual and expected are empty
   ...
   */
  public void assertIntersectsAll(AssertionInfo info, RangeSet actual, RangeSet rangeSet) {
    assertNotNull(info, actual);
    failIfNull(rangeSet);
    // Should pass if both actual and expected are empty
   ...
   */
  public void assertEmpty(AssertionInfo info, RangeSet actual) {
    assertNotNull(info, actual);
   ...
   */
  public void assertNotEmpty(AssertionInfo info, RangeSet actual) {
    assertNotNull(info, actual);
   ...
   */
  public void assertNullOrEmpty(AssertionInfo info, RangeSet actual) {
   ...
   * @throws IllegalArgumentException if ranges are null or ranges are empty while actual is not empty.
   */
  public void assertIntersectsAnyOf(AssertionInfo info, RangeSet actual, Range[] ranges) {
    assertNotNull(info, actual);
    failIfNull(ranges);
    // Should pass if both actual and expected are empty
    if (actual.isEmpty() && ranges.length == 0) return;
   ...
   * @throws IllegalArgumentException if ranges are null or ranges are empty while actual is not empty.
   */
  public void assertDoesNotIntersect(AssertionInfo info, RangeSet actual, Range[] ranges) {
    assertNotNull(info, actual);
   ...
   * @throws IllegalArgumentException if ranges are null or ranges are empty while actual is not empty.
   */
  public void assertEncloses(AssertionInfo info, RangeSet actual, Range[] ranges) {
    assertNotNull(info, actual);
    failIfNull(ranges);
    // Should pass if both actual and expected are empty
    if (actual.isEmpty() && ranges.length == 0) return;
   ...
   * @throws IllegalArgumentException if range is null or range is empty while actual is not empty.
   */
  public void assertEnclosesAll(AssertionInfo info, RangeSet actual, Iterable<? extends Range> range) {
    assertNotNull(info, actual);
    failIfNull(range);
    // Should pass if both actual and expected are empty
    if (actual.isEmpty() && !range.iterator().hasNext()) return;
   ...
   * @throws IllegalArgumentException if range set is null or range set is empty while actual is not empty.
   */
  public void assertEnclosesAll(AssertionInfo info, RangeSet actual, RangeSet rangeSet) {
    assertNotNull(info, actual);
    failIfNull(rangeSet);
    // Should pass if both actual and expected are empty
    if (actual.isEmpty() && rangeSet.isEmpty()) return;
   ...
   * @throws IllegalArgumentException if ranges are null or ranges are empty while actual is not empty.
   */
  public void assertEnclosesAnyOf(AssertionInfo info, RangeSet actual, Range[] ranges) {
    assertNotNull(info, actual);
    failIfNull(ranges);
    // Should pass if both actual and expected are empty
    if (actual.isEmpty() && ranges.length == 0) return;
   ...
   * @throws IllegalArgumentException if ranges are null or ranges are empty while actual is not empty.
   */
  public void assertDoesNotEnclose(AssertionInfo info, RangeSet actual, Range[] ranges) {
    assertNotNull(info, actual);
    failIfNullOrEmpty(ranges);
